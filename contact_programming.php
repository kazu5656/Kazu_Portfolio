...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
        ...
        if (empty($err)) {
                    ...
                    $mail_title = '【プログラミング】お問い合わせがありました。';
                    ...
                    $mail_body.= 'この度は【プログラミング】についてお問い合わせをいただきありがとうございます。'.PHP_EOL.PHP_EOL;
      ...
      <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-heading left white">
                ...
                <?php endif; ?>
                <p>何かご質問があれば、ご遠慮なく<br class="br-携帯短" />お問い合わせください。<br>
                  ...
                  <a href="privacy_policy_programming.php"><input type="" value="プライバシーポリシーを確認する" class="btn btn-info btn-block"></a>
