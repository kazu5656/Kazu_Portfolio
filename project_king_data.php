          ...
          <div class="col-lg-7 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td id="サービス名">サッカースクール用 データ管理アプリ</td>
                        </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2">作者が運営するサッカースクールのデータを登録するアプリです。</td>
                      </tr>
                    </tbody>
                </table>
              </div>
  				...
  				<div class="row">
  						...
  						<div class="col-lg-7 col-md-12 sm-margin-50px-bottom xs-margin-30px-bottom">
  							<div class="owl-carousel owl-theme text-center">
  									<div class="item"><img class="写真" src="https://kazu0520.sakura.ne.jp/Kazu_Portfolio/img/content/king_data_insert.JPG" alt="" /></div>
