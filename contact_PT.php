...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
        ...
        if (empty($err)) {
                    ...
                    mb_language("japanese");
                    mb_internal_encoding("UTF-8");
                    $mail_title = 'パーソナルトレーニングについてのお問い合わせありがとうございます。';
...
<head>
		...
		<title>PT お問い合わせフォーム | <?php echo SERVICE_NAME; ?></title>
          ...
          <div class="col-md-12">
            ...
            <div class="section-heading left white">
                ...
                <p>パーソナルトレーニングについて<br class="br-携帯短" />何かご質問があれば、ご遠慮なく<br class="br-携帯短" />お問い合わせください。<br>
                  ...
                  <a href="privacy_policy_pt.php"><input type="" value="プライバシーポリシーを確認する" class="btn btn-info btn-block"></a>
