          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2"><b>ユーザー</b>　一つのビデオに複数のタグをつける作業が必要な方</td>
                      </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2">一つのビデオに複数のタグを一度で効率良くつけることができるアプリです。<br>
                          作者がサッカースクールで撮影したビデオを効率よくタグ付けするために開発しました。<br>
                          今でも毎週使用していて大幅な業務効率化につながりました。<br>
                          作者のサッカーコーチとしての活動は<a href="king_of_football_index.php"target="_blank">こちら</a>。</td>
                      </tr>
                    </tbody>
                </table>
              </div>
  				...
  				<div class="row">
  						...
  						<div class="col-lg-7 col-md-12 sm-margin-50px-bottom xs-margin-30px-bottom">
  							<div class="owl-carousel owl-theme text-center">
  									<div class="item"><img class="写真" src="https://kazu0520.sakura.ne.jp/Kazu_Portfolio/img/content/videotag.JPG" alt="" /></div>
