          ...
          <div class="col-lg-5 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td id="URL"><a href="https://kazu0520.sakura.ne.jp/wordpress/"target="_blank">https://kazu0520.sakura.ne.jp/wordpress/</a></td>
                        </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2"><b>ユーザー</b>　ヒーローやアスリートの”言葉”から力をもらいたい方</td>
                      </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2">毎朝7時にヒーローやアスリートの名言が自動投稿されるブログです。</td>
                      </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2"><b>技術</b>　HTML・CSS・PHP・SQL・wordpress・CRON</td>
                      </tr>
                    </tbody>
                </table>
              </div>
  				...
  				<div class="row">
  						...
  						<div class="col-lg-7 col-md-12 sm-margin-50px-bottom xs-margin-30px-bottom">
  							<div class="owl-carousel owl-theme text-center">
  									<div class="item"><img class="写真" src="https://kazu0520.sakura.ne.jp/Kazu_Portfolio/img/content/powerwords.JPG" alt="" /></div>
  							</div>
  						</div>
              ...
              <div class="col-lg-5 col-md-12">
                    ...
                    <table class="table table-bordered" id="テーブル2">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  <td>・名言をCRONで自動投稿（別アプリ）</td>
                              </tr>
                              <tr>
                                  <td>・名言の登録（別アプリ）</td>
                              </tr>
                              <tr>
                                  <td>・名言のカテゴリー分け（別アプリ）</td>
                              </tr>
