          ...
          <div class="col-lg-5 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td id="URL"><a href="https://animal-photo-smile.com"target="_blank">https://animal-photo-smile.com</a></td>
                        </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2"><b>ユーザー</b>　お笑いが好きな方、動物が好きな方</td>
                      </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2">かわいい動物写真とお題に対してボケていくWebサービスです。</td>
                      </tr>
                    </tbody>
                </table>
              </div>
          ...
          <div class="col-lg-12 col-md-12">
              <div class="padding-0px-left md-padding-0px-left sm-no-padding">
                <table class="table table-bordered">
                    <tbody>
                      <tr id="サービスの説明文">
                          <td colspan="2"><b>技術</b>　HTML・CSS・PHP・SQL・JavaScript・JQuery・Bootstrap・CRON</td>
                      </tr>
                    </tbody>
                </table>
              </div>
  				...
  				<div class="row">
  						...
  						<div class="col-lg-7 col-md-12 sm-margin-50px-bottom xs-margin-30px-bottom">
  							<div class="owl-carousel owl-theme text-center">
  									<div class="item"><img class="写真" src="https://kazu0520.sakura.ne.jp/Kazu_Portfolio/img/content/photosmile1.JPG" alt="" /></div>
                    <div class="item"><img class="写真" src="https://kazu0520.sakura.ne.jp/Kazu_Portfolio/img/content/photosmile2.JPG" alt="" /></div>
