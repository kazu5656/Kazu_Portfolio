...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
        ...
        if (empty($err)) {
                    ...
                    // 差出人
                    $mailfrom="From:" .mb_encode_mimeheader("kazu-football") ."";

                    // 管理者にメールを送信"
                    mb_language("japanese");
                    mb_internal_encoding("UTF-8");
                    $mail_title = '【サッカースクール】お問い合わせがありました。';
                    ...
                    mb_language("japanese");
                    mb_internal_encoding("UTF-8");
                    $mail_title = 'KING OF FOOTBALLについてのお問い合わせありがとうございます。';
                    $mail_body = $user_name. ' 様'.PHP_EOL.PHP_EOL;
                    $mail_body.= 'この度は【KING OF FOOTBALL】についてのお問い合わせをいただきありがとうございます。'.PHP_EOL.PHP_EOL;
...
<head>
		...
		<title>サッカースクール お問い合わせフォーム | <?php echo SERVICE_NAME; ?></title>
      ...
      <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-heading left white">
                ...
                <?php endif; ?>
                <p>サッカースクール <br class="br-携帯短" />KING OF FOOTBALL について<br class="br-携帯短" />何かご質問があれば、ご遠慮なく<br class="br-携帯短" />お問い合わせください。<br>
                  ...
                  <a href="privacy_policy_football.php"><input type="" value="プライバシーポリシーを確認する" class="btn btn-info btn-block"></a>
